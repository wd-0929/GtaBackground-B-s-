...
namespace GtaBackground.DAL
{
    ...
    public static class TypeExtension
    {
        ...
        /// <summary>
        /// 获取时间或者默认时间，数据库中的默认时间为2000-01-01 00:00:00
        /// </summary>
        /// <param name="time"></param>
        /// <returns></returns>
        public static DateTime GetValueOrDefaultByDb(this DateTime? time)
        {
            return time.GetValueOrDefault(new DateTime(2000, 1, 1));
        }
